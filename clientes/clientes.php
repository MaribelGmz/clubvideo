            ...
            <?php
                require_once("../bd/conexion.php");
                    ...
                    while  (($row = mysqli_fetch_array($result))!=NULL)
                    {
                        ...
                        <td class='active'>$fecha_nacimiento</td>
                      
                        <td class='active align='center'><center><a href='modificar.php?id_cli=$id_cli'><i class='fa fa-user-circle'></i></a></center></td>
                        <td class='active' align='center'><a onClick='confirmar($id_cli)'><i class='fa fa-user-times'></i></a></td>
