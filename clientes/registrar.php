    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <center><h1><h1 class="chivas"> Registrar cliente</h1></center>
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="alta_clientes.php" method="post" id="frmaltaclientes">
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese el nombre" autofocus required pattern="[a-zA-Z]+"></td>
                      </tr> 
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="correo_electronico">Correo electrónico:</label></td><td><input type="email" class="form-control" name="correo_electronico" id="correo_electronico" placeholder="Ingrese su correo electrónico" required></td>
                      </tr>

                     <tr class="espacio"> 
                      <td align="right"> <label for="fecha_nacimiento">Fecha de nacimiento:</label></td><td><input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" placeholder="Ingrese su fecha de nacimineto" required></td>
                      </tr>   
