        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="modificar_clientes.php" method="post" id="frmmodificarclientes">
                      <input type="hidden" class="form-control" name="id_cli" id="id_cli" value="<?php echo $consulta['id_cli'];?>">
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $consulta['nombre'];?>"autofocus required pattern="[a-zA-Z]+"></td>
                      </tr>

                     
                      <td align="right"> <label for="apellidos">Apellidos:</label></td><td><input type="text" class="form-control" name="apellidos" id="apellidos" value="<?php echo $consulta['apellidos'];?>"autofocus required pattern="[a-zA-Z]+"></td>
                      </tr>
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="telefono">Telefono:</label></td><td><input type="number" class="form-control" name="telefono" id="telefono" value="<?php echo $consulta['telefono'];?>" required></td>
                      </tr>  

                      <tr class="espacio"> 
                      <td align="right"> <label for="correo_electronico">Correo electronico:</label></td><td><input type="email" class="form-control" name="correo_electronico" id="correo_electronico" value="<?php echo $consulta['correo_electronico'];?>" required></td>
                      </tr>  

                      <tr class="espacio"> 
                      <td align="right"> <label for="fecha_nacimiento">Fecha de nacimiento:</label></td><td><input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" value="<?php echo $consulta['fecha_nacimiento'];?>" required></td>
                      </tr>
