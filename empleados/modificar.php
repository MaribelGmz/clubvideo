        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <tr class="espacio"> 
                      <td align="right"> <label for="sueldo">Sueldo:</label></td><td><input type="int" step="any" class="form-control" name="sueldo" id="sueldo" value="<?php echo $consulta['sueldo'];?>" required pattern="[0-9]+"></td>
                      </tr>

                      <tr class="espacio"> 
                      <td align="right"> <label for="puesto">Puesto:</label></td><td><input type="text" class="form-control" name="puesto" id="puesto" value="<?php echo $consulta['puesto'];?>" required></td>
                      </tr>
