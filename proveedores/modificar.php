        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                      ...
                      $opcion = $_GET['id_prov'];
                      $result=mysqli_query($link,"SELECT * FROM proveedores where id_prov='$opcion'");
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="modificar_proveedores.php" method="post" id="frmmodificarclientes">
                      <input type="hidden" class="form-control" name="id_prov" id="id_prov" value="<?php echo $consulta['id_prov'];?>">
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $consulta['nombre'];?>"autofocus required></td>
                      </tr>
...
<script language="javascript"> 
        function confirmar(id_prov){ 
        confirmar=confirm("\u00bfRealmente deseas eliminar el registro?"); 
        if (confirmar) 
        {
        document.location="eliminar_clientes.php?opcion="+id_prov;
        }
        else  
        {
        } 
