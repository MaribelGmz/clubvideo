...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Menu peliculass-->
             <li class="nav-item">
                ...
                <div id="collapseRefacciones" class="collapse" aria-labelledby="headingRefacciones" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <center><h1>Consultar proveedor</h1></center>
            ...
            <td class='active align='center'><center><a href='modificar.php?id_prov=$id_prov'><i class='fa fa-user-circle'></i></a></center></td>
                        <td class='active' align='center'><a onClick='confirmar($id_prov)'><i class='fa fa-user-times'></i></a></td>
    ...
    <script language="javascript"> 
        ...
        if (confirmar) 
        {
        document.location="eliminar_proveedores.php?opcion="+id_prov;
        }
        else  
        {
        } 
