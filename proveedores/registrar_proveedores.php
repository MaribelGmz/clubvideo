    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <center><h1>Registrar proveedores</h1></center>
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="alta_proveedores.php" method="post" id="frmaltaproveedores">
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="nombre">Nombre:</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese nombre del proveedor" autofocus required></td>
                      </tr> 
