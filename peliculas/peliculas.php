    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <center><h1>Consultar peliculas</h1></center>
            ...
            <?php
                require_once("../bd/conexion.php");
                    ...
                    <th class='success'>Género</th>
                    <th class='success'>Duración</th>
                    <th class='success'>Fecha de publicación</th>
                    <th class='success'>Existencias</th>
                    ...
                    while  (($row = mysqli_fetch_array($result))!=NULL)
                    {
                        ...
                        echo "<tr>
                        <td class='active'>$titulo</td>
                        <td class='active'>$director</td>
                        <td class='active'>$genero</td>
                        <td class='active'>$duracion</td>
                        <td class='active'>$fecha_publicacion</td>
                        <td class='active'>$existencias</td>

                       <td class='active align='center'><center><a href='modificar.php?id_pelicula=$id_pelicula'><i class='fa fa-user-circle'></i></a></center></td>
                        <td cltiass='acve' align='center'><a onClick='confirmar($id_pelicula)'><i class='fa fa-user-times'></i></a></td>
