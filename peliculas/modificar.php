...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseClientes" class="collapse" aria-labelledby="headingClientes" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="clientes.php">Consultar</a>
            ...
            <!-- Menu empleados-->
             <li class="nav-item">
                ...
                <div id="collapseEmpleados" class="collapse" aria-labelledby="headingEmpleados" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../empleados/registrar_empleados.php">Registrar</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                      ...
                      $opcion = $_GET['id_pelicula'];
                      $result=mysqli_query($link,"SELECT * FROM peliculas where id_pelicula='$opcion'");
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="modificar_peliculas.php" method="post" id="frmmodificarpelicula">
                      <input type="hidden" class="form-control" name="id_pelicula" id="id_cli" value="<?php echo $consulta['id_pelicula'];?>">
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="titulo">Titulo:</label></td><td><input type="text" class="form-control" name="titulo" id="titulo" value="<?php echo $consulta['titulo'];?>"autofocus required></td>
                      </tr>

                     
                      <td align="right"> <label for="director">Director:</label></td><td><input type="text" class="form-control" name="director" id="director" value="<?php echo $consulta['director'];?>"autofocus required></td>
                      </tr>


                      <tr class="espacio"> 
                      <td align="right"> <label for="fecha_publicacion">Fecha de publicacion:</label></td><td><input type="date" class="form-control" name="fecha_publicacion" id="fecha_publicacion" value="<?php echo $consulta['fecha_publicacion'];?>" required></td>
                      </tr>
                       
                     <tr class="espacio"> 
                      <td align="right"> <label for="genero">Género:</label></td><td><input type="text" class="form-control" name="genero" id="genero" placeholder="Ingrese el genero de la película" value="<?php echo $consulta['genero'];?>" required></td>
                      </tr>
                     
                      <tr class="espacio"> 
                      <td align="right"> <label for="duracion">Duración:</label></td><td><input type="text" class="form-control" name="duracion" id="duracion" placeholder="Ingrese la duración de la película" value="<?php echo $consulta['duracion'];?>" required></td>
                      </tr>

                     <tr class="espacio"> 
                      <td align="right"> <label for="existencias">Existencias:</label></td><td><input type="int" class="form-control" name="existencias" id="existencias" placeholder="Ingrese la cantidad en existencia" value="<?php echo $consulta['existencias'];?>" required></td>
    ...
    <script language="javascript"> 
        function confirmar(id_pelicula){ 
        confirmar=confirm("\u00bfRealmente deseas eliminar el registro?"); 
        if (confirmar) 
        {
        document.location="eliminar_clientes.php?opcion="+id_pelicula;
        }
        else  
        {
        } 
