...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
            <div id="content">
                <header><center><h1 class="chivas">Video Club</h1></center></header>
                ...
                <!-- Begin Page Content -->
                <center><h1><h1 class="chivas"> Registrar peliculas</h1></center>
                ...
                <div class="col-md-6 offset-md-3">
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="alta_peliculas.php" method="post" id="frmaltapeliculas">
                      <tr class="espacio"> 
                      <td align="right"> <label for="titulo">Titulo:</label></td><td><input type="text" class="form-control" name="titulo" id="titulo" placeholder="Ingrese el título" autofocus required></td>
                      </tr> 

                      <tr class="espacio"> 
                      <td align="right"> <label for="director">Director:</label></td><td><input type="text" class="form-control" name="director" id="director" placeholder="Ingrese el nombre del dierctor" required></td>
                      </tr>

                      <tr class="espacio"> 
                      <td align="right"> <label for="fecha_publicacion">Fecha de publicacion:</label></td><td><input type="date" class="form-control" name="fecha_publicacion" id="fecha_publicacion" placeholder="Ingrese la fecha de publicacion" required></td>
                      </tr> 

                      <tr class="espacio"> 
                      <td align="right"> <label for="genero">Género:</label></td><td><input type="text" class="form-control" name="genero" id="genero" placeholder="Ingrese el genero de la película" required></td>
                      </tr>
                     
                      <tr class="espacio"> 
                      <td align="right"> <label for="duracion">Duración:</label></td><td><input type="text" class="form-control" name="duracion" id="duracion" placeholder="Ingrese la duración de la película" required></td>
                      </tr>

                     <tr class="espacio"> 
                      <td align="right"> <label for="existencias">Existencias:</label></td><td><input type="int" class="form-control" name="existencias" id="existencias" placeholder="Ingrese la cantidad en existencia" required></td>
                      </tr>
    ...
    <script language="javascript"> 
        ...
        if (confirmar) 
        {
        document.location="eliminar_peliculas.php?opcion="+id_pelicula;
        }
        else  
        {
        } 
